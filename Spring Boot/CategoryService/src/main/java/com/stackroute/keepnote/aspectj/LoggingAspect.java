...
public class LoggingAspect {
	...
	@Before("execution(* com.stackroute.keepnote.controller.CategoryController.deleteCategory(..))")
	...
	@After("execution(* com.stackroute.keepnote.controller.CategoryController.deleteCategory(..))")
	...
	@AfterReturning(pointcut = "execution(* com.stackroute.keepnote.controller.CategoryController.deleteCategory(..))", returning = "result")
	...
	@AfterThrowing(pointcut = "execution(* com.stackroute.keepnote.controller.CategoryController.deleteCategory(..))", throwing = "error")
